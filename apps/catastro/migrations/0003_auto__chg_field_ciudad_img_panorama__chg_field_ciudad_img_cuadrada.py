...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ciudad.img_panorama'
        db.alter_column('catastro_ciudad', 'img_panorama', self.gf('django.db.models.fields.files.ImageField')(max_length=200, null=True))

        # Changing field 'Ciudad.img_cuadrada'
        db.alter_column('catastro_ciudad', 'img_cuadrada', self.gf('django.db.models.fields.files.ImageField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Ciudad.img_panorama'
        db.alter_column('catastro_ciudad', 'img_panorama', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Ciudad.img_cuadrada'
        db.alter_column('catastro_ciudad', 'img_cuadrada', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
