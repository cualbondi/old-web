...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Poi.latlng'
        db.alter_column('catastro_poi', 'latlng', self.gf('django.contrib.gis.db.models.fields.GeometryField')(geography=True))

    def backwards(self, orm):

        # Changing field 'Poi.latlng'
        db.alter_column('catastro_poi', 'latlng', self.gf('django.contrib.gis.db.models.fields.PointField')())
