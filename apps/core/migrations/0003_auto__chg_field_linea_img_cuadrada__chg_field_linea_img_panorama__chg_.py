...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Linea.img_cuadrada'
        db.alter_column('core_linea', 'img_cuadrada', self.gf('django.db.models.fields.files.ImageField')(max_length=200, null=True))

        # Changing field 'Linea.img_panorama'
        db.alter_column('core_linea', 'img_panorama', self.gf('django.db.models.fields.files.ImageField')(max_length=200, null=True))

        # Changing field 'Recorrido.img_cuadrada'
        db.alter_column('core_recorrido', 'img_cuadrada', self.gf('django.db.models.fields.files.ImageField')(max_length=200, null=True))

        # Changing field 'Recorrido.img_panorama'
        db.alter_column('core_recorrido', 'img_panorama', self.gf('django.db.models.fields.files.ImageField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Linea.img_cuadrada'
        db.alter_column('core_linea', 'img_cuadrada', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Linea.img_panorama'
        db.alter_column('core_linea', 'img_panorama', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Recorrido.img_cuadrada'
        db.alter_column('core_recorrido', 'img_cuadrada', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Recorrido.img_panorama'
        db.alter_column('core_recorrido', 'img_panorama', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
