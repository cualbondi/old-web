...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Linea.img'
        db.alter_column('core_linea', 'img', self.gf('django_thumbs.db.models.ImageWithThumbsField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Linea.img'
        db.alter_column('core_linea', 'img', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
